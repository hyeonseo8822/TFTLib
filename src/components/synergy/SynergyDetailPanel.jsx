...
export function SynergyDetailPanel({ synergy }) {
  return (
    <aside className="w-full md:w-[1000px] p-margin bg-surface-container-low flex flex-col gap-lg overflow-y-auto max-h-screen custom-scrollbar sticky top-20">      <SynergyDetailHeader synergy={synergy} />
